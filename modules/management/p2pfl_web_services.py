...
import requests  # DOCs: https://pypi.org/project/requests/
...
class P2pflWebServices:
    ...
    def send_log(
        self, time: datetime.datetime, node: str, level: int, message: str
    ) -> None:
        """
        Send a log message.
    ...
    def send_system_metric(
        self, node: str, metric: str, value: float, time: datetime.datetime
    ):
        """
        Send a metric.
