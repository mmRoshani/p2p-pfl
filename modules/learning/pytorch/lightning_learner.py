...
from helpers.exceptions.learning_exceptions import (
    DecodingParamsError,
    ModelNotMatchingError,
)
from interfaces.learner import NodeLearner
from modules.learning.pytorch.lightning_logger import FederatedLogger
        ...
        try:
            if self.epochs > 0:
                ...
                for k, v in results.items():
                    self.log.log_metric(self.__self_addr, k, v)
                return results
            else:
                return {}
        except Exception as e:
