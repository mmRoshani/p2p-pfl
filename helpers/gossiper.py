...
class Gossiper(threading.Thread):
    ...
    def start(self) -> None:
        ...
        self.log.info(self.__self_addr, "Starting gossiper...")
        return super().start()

    def stop(self) -> None:
        """Stop the gossiper thread."""
        self.log.info(self.__self_addr, "Stopping gossiper...")
    ...
    def gossip_weights(
        ...
        while True:
            ...
            if early_stopping_fn():
                self.log.info(self.__self_addr, "Stopping model gossip process.")
                return
            ...
            if neis == []:
                self.log.info(self.__self_addr, "Gossip finished.")
                return
            ...
            for nei in neis:
                ...
                if model is None:
                    continue
                self.log.info(self.__self_addr, f"Gossiping model to {nei}.")
